...
class YOLOObjective:
    def __init__(self, log_path="results/usa/ecp_yolo8n_small_train_log.csv"): # change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="runs/detect/results/usa/rslt_yolo8n_small_train_finetuning_auto_on_golden_best_params" # path to saving directory ( change as needed)
        ...
        try:
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/usa/rslt_yolo8n_small_train_finetuning_auto_on_golden_best_params", # path to saving directory ( change as needed)
                name=exp_name,
            )
